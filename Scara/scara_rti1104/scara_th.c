/************************ dSPACE target specific file *************************
   ...
   Include file .\scara_rti1104\scara_th.c :

   Task Configuration file for model : scara

   RTI1104 7.4 (02-May-2015)/2.10
   25-Nov-2021 10:18:38
...
# ifdef MULTITASKING
#   error Cannot compile in multiple timer tasks mode (.\scara_rti1104\scara_th.c is for ST).
# endif
